    ...
    <view class="login-page">
        <view class="header">
            ...
            <view class="logo-area">
                ...
                <text class="title">司机端登录</text>
                <text class="subtitle">专业接送，安全出行</text>
            </view>
        </view>
        ...
        <view class="login-form">
            ...
            <view class="register-link">
                <text>还没有账号？</text>
                <text class="link" @click="goRegister">联系管理员注册</text>
            </view>
        </view>
...
function showAgreement() {
    uni.showModal({
        title: '用户协议',
        content: '欢迎使用校园接送车司机端。本协议是您与本平台之间关于使用服务的协议。请仔细阅读本协议。',
        showCancel: false
    })
}
